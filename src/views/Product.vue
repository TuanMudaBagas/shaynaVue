						...
						<div class="row">
							<div class="col-lg-6">
								...
								<div class="product-thumbs">
									<Carosel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
										<div
											class="pt"
...
<script>
import Header from "./../components/Headershayna";
import Related from "./../components/Relatedshayna";
import Footer from "./../components/Footershayna";
import Carosel from "vue-owl-carousel";
export default {
	name: "Product",
	components: {
		Header,
